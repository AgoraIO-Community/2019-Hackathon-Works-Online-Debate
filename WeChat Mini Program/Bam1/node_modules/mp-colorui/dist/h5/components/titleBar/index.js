...
export default class ClTitleBar extends Taro.Component {
  render() {
    ...
    const borderComponent = <View className="action border-title justify-between">
        <View>
          <Text className={`${textColorClassName} text-bold text-xl`}>
            {this.props.title}
          </Text>
          <Text className={`${borderColorClassName}`} style={{ width: `${Taro.pxTransform(this.props.borderLong || 20)}` }} />
        </View>
        <View>
          {this.props.renderRight}
        </View>
      </View>;
    const subComponent = <View className="action sub-title justify-between">
        <View>
          <Text className={`text-xl text-bold ${textColorClassName}`}>
            {this.props.title}
          </Text>
          {this.props.subTitle ? <Text className={`text-${this.props.subTitleColor}`}>
              {this.props.subTitle}
            </Text> : <Text className={`${borderColorClassName}`}></Text>}
        </View>
        <View>
          {this.props.renderRight}
        </View>
      </View>;
    const iconComponent = <View className="action justify-between">
        <View>
    ...
    return <View className={`${bgColorClassName} cu-bar`}>
