...
import Taro, { createSelectorQuery as _createSelectorQuery, getSystemInfoSync as _getSystemInfoSync } from "@tarojs/taro-h5";
import { screenPercent } from "../utils/index";
import './index.scss';
import { BG_COLOR_LIST } from '../utils/model';
import ClText from "../text/index";
import ClTip_H5 from "./h5/index";
export default class ClTip extends Taro.Component {
  render() {
    ...
    const clTip = <View id="content" onClick={() => {
      if (props.mode === 'click') {
        const show = !showTip;
        setShowTip(show);
    ...
    <View id="message" className={`cl-tip__content  shadow ${showTip ? 'show' : 'hide'}`} style={{
